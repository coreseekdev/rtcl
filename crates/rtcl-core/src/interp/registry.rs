...
static CMD_TABLE: &[CmdEntry] = &[
    ...
    CmdEntry { name: "lsearch",   func: list::cmd_lsearch,       cat: Standard, cmd_id: Some(CmdId::Lsearch   as u16),   usage: "?options? list pattern",           help: "Search a list" },
    CmdEntry { name: "lsort",     func: list::cmd_lsort,         cat: Standard, cmd_id: Some(CmdId::Lsort     as u16),   usage: "?options? list",                   help: "Sort a list" },
